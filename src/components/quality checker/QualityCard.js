            ...
            <div className="card">
                <div className="card-header p-3 pt-2">
                    ...
                    <div className="text-end pt-1">
                        <p className="display-6 mb-0 text-capitalize font-weight-bolder">{crop}</p>
                    </div>
                </div>
                ...
                <div className="row">
                    ...
                    <div className="card-footer p-2" >
                        <p className="mb-0"><span className="text-success text-sm font-weight-bolder" >Processor ID :</span>&nbsp;&nbsp;{processor}&nbsp;&nbsp;&nbsp;&nbsp;</p>
                    </div>
                </div>
                <div className='farmerproduct-body mt-1'>
                    <form role="form" action="" method="POST" name="form">
                        <div class="input-group input-group-outline mb-3">
                            <input type="text" id="N" name="N" class="form-control" placeholder='Sample Size' />
                        </div>
                        <div class="input-group input-group-outline mb-3">
                            <input type="text" id="P" name="P" class="form-control" placeholder='Defective' />
                        </div>
                        ...
                        <div class="text-center">
                            <button type="submit" name="broadcastCrop"
                                class="btn btn-lg bg-gradient-info btn-lg w-100 mt-4 mb-0">Push Report</button>
                        </div>
                    </form>
                </div>
            </div>
